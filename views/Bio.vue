...
<div>
    ...
    <div class="pt-7">
        ...
        <p class="font-thin text-sm pb-2.5">
            Additionally, I have gained invaluable experience by participating in Bug Bounty programs, engaging in vulnerability discovery and assessment, as well as developing related tools for such tasks. I also have played the role of a Teacher Assistant in the Computer Networks course at my university.
        </p>
        <p class="font-thin text-sm pb-2.5">
